...
static inline std::uint32_t F(const std::uint32_t& x, const std::uint32_t& y,
                              const std::uint32_t& z)
{
    return (z ^ (x & (y ^ z)));
}

static inline std::uint32_t G(const std::uint32_t& x, const std::uint32_t& y,
                              const std::uint32_t& z)
{
    return (y ^ (z & (y ^ x)));
}

static inline std::uint32_t H(const std::uint32_t& x, const std::uint32_t& y,
                              const std::uint32_t& z)
{
    return (x ^ y ^ z);
}

static inline std::uint32_t I(const std::uint32_t& x, const std::uint32_t& y,
                              const std::uint32_t& z)
{
    return (y ^ (x | (~z)));
}

static inline void FF(std::uint32_t& a, std::uint32_t& b, std::uint32_t& c,
                      std::uint32_t& d, std::uint32_t M, std::uint32_t s,
                      std::uint32_t t)
{
    a = (a + F(b, c, d) + M + t);
    a = rol32(a, s) + b;
...
static inline void GG(std::uint32_t& a, std::uint32_t& b, std::uint32_t& c,
                      std::uint32_t& d, std::uint32_t M, std::uint32_t s,
                      std::uint32_t t)
{
    a = (a + G(b, c, d) + M + t);
...
static inline void HH(std::uint32_t& a, std::uint32_t& b, std::uint32_t& c,
                      std::uint32_t& d, std::uint32_t M, std::uint32_t s,
                      std::uint32_t t)
{
    a = (a + H(b, c, d) + M + t);
...
static inline void II(std::uint32_t& a, std::uint32_t& b, std::uint32_t& c,
                      std::uint32_t& d, std::uint32_t M, std::uint32_t s,
                      std::uint32_t t)
{
    a = (a + I(b, c, d) + M + t);
...
void MD5::finalize(void* digest)
{
    ...
    for (size_t i = 0; i < 4; i++)
    {
        digest_detail::store32l(state_[i],
