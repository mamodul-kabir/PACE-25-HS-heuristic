...
static inline std::uint32_t F0(const std::uint32_t& x, const std::uint32_t& y,
                               const std::uint32_t& z)
{
    return (z ^ (x & (y ^ z)));
}

static inline std::uint32_t F1(const std::uint32_t& x, const std::uint32_t& y,
                               const std::uint32_t& z)
{
    return (x ^ y ^ z);
}

static inline std::uint32_t F2(const std::uint32_t& x, const std::uint32_t& y,
                               const std::uint32_t& z)
{
    return ((x & y) | (z & (x | y)));
}

static inline std::uint32_t F3(const std::uint32_t& x, const std::uint32_t& y,
                               const std::uint32_t& z)
{
    return (x ^ y ^ z);
}
...
void SHA1::finalize(void* digest)
{
    ...
    for (size_t i = 0; i < 5; i++)
        digest_detail::store32h(state_[i],
